                    ...
                    <div class="flex flex-col gap-4">
                        @if($book->cover_image)
                            <div>
                                ...
                                <img src="data:image/jpeg;base64,{{ base64_encode($book->cover_image) }}" alt="Current Cover" class="h-24 w-16 object-cover rounded-lg border border-gray-200 shadow-sm">
                            </div>
                        @endif
