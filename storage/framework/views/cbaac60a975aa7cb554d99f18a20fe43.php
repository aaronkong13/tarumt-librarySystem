...
<body class="bg-gray-900/50 min-h-screen flex items-center justify-center p-4 backdrop-blur-sm">
    ...
    <div class="bg-white rounded-3xl w-full max-w-2xl shadow-2xl overflow-hidden relative">
        ...
        <div class="p-8">
            ...
            <form action="<?php echo e(route('books.store')); ?>" method="POST" enctype="multipart/form-data" charset="UTF-8" class="space-y-6">
                <?php echo csrf_field(); ?>
...
</html><?php /**PATH C:\Users\Cheng\Documents\GitHub\tarumt-librarySystem\resources\views/books/create.blade.php ENDPATH**/ ?>