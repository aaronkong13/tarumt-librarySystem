...
<body class="bg-[#F3F4F6] text-gray-800">
    ...
    <div class="flex min-h-screen">
        ...
        <!-- Sidebar -->
        <?php echo $__env->make('layouts.sidebar', ['active' => 'users'], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
                    ...
                    <div class="flex items-center">
                        ...
                        <div class="ml-5 w-0 flex-1">
                            <dl>
                                ...
                                <dd class="text-lg font-bold text-gray-900"><?php echo e($users->total()); ?></dd>
                            </dl>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="ml-5 w-0 flex-1">
                            <dl>
                                ...
                                <dd class="text-lg font-bold text-gray-900">
                                    <?php echo e(App\Models\User::where('role', 'Student')->count()); ?>
                    ...
                    <div class="flex items-center">
                        ...
                        <div class="ml-5 w-0 flex-1">
                            <dl>
                                ...
                                <dd class="text-lg font-bold text-gray-900">
                                    <?php echo e(App\Models\User::where('role', 'Staff')->count()); ?>
                            ...
                            <dl>
                                ...
                                <dd class="text-lg font-bold text-gray-900">
                                    <?php if(Auth::user()->role === 'Admin'): ?>
                                        <?php echo e(App\Models\User::where('status', 'Active')->where('role', '!=', 'Admin')->count()); ?>

                                    <?php elseif(Auth::user()->role === 'Staff'): ?>
                                        <?php echo e(App\Models\User::where('status', 'Active')->whereNotIn('role', ['Admin', 'Staff'])->count()); ?>

                                    <?php else: ?>
                                        <?php echo e(App\Models\User::where('status', 'Active')->count()); ?>
            ...
            <div id="userTableContainer" class="relative min-h-[400px]">
                ...
                <table class="min-w-full divide-y divide-gray-200">
                    ...
                    <tbody id="userTableBody" class="bg-white divide-y divide-gray-200">
                        ...
                        <tr class="hover:bg-gray-50 transition-colors duration-150" data-user-id="<?php echo e($user->id); ?>">
                                    ...
                                    <div class="flex-shrink-0 h-10 w-10">
                                        ...
                                        <?php else: ?>
                                            <div class="h-10 w-10 bg-indigo-500 rounded-full flex items-center justify-center">
                                                <span class="text-white font-semibold text-sm"><?php echo e(strtoupper(substr($user->name, 0, 2))); ?></span>
                                            </div>
                                        <?php endif; ?>
                                    </div>
                                    <div class="ml-4">
                            ...
                            <td class="px-6 py-4 whitespace-nowrap">
                                ...
                                <div class="text-xs text-gray-500"><?php echo e($user->phone ?? 'No phone'); ?></div>
                            </td>
                            ...
                            <td class="px-6 py-4 whitespace-nowrap text-center">
                                <span class="status-badge px-2 inline-flex text-xs leading-5 font-semibold rounded-full <?php echo e($user->status === 'Active' ? 'bg-green-100 text-green-800' : 'bg-gray-100 text-gray-800'); ?>">
                            ...
                            <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium space-x-2">
                                <?php if(app(\App\Services\AccessControlService::class)->canViewUser($user)): ?>
                                    <a href="<?php echo e(route('users.show', $user->id)); ?>" class="text-blue-600 hover:text-blue-900" title="View">
                                        <i class="fa-solid fa-eye text-lg"></i>
                                    </a>
                                <?php endif; ?>

                                <?php if(app(\App\Services\AccessControlService::class)->canEditUser($user)): ?>
                                    <a href="<?php echo e(route('users.edit', $user->id)); ?>" class="text-yellow-600 hover:text-yellow-900" title="Edit">
                                        <i class="fa-solid fa-pen-to-square text-lg"></i>
                                    </a>
                                <?php endif; ?>

                                <?php if(app(\App\Services\AccessControlService::class)->canDeactivateUser($user)): ?>
                ...
                <?php if($users->hasPages()): ?>
                    <div class="flex items-center justify-between">
                        <div class="text-sm text-gray-700">
                            Showing <span class="font-medium"><?php echo e($users->firstItem()); ?></span> to 
                            <span class="font-medium"><?php echo e($users->lastItem()); ?></span> of 
...
<?php /**PATH C:\Users\Cheng\Documents\GitHub\tarumt-librarySystem\resources\views/users/index.blade.php ENDPATH**/ ?>