...
<body class="bg-[#F3F4F6] text-gray-800">
        ...
        <main class="flex-1 md:ml-64 relative">
            ...
            <div class="p-8">
                    ...
                    <div class="bg-[#E0E7FF] p-6 rounded-2xl relative overflow-hidden group">
                        <div class="flex justify-between items-start">
                            <div>
                                ...
                                <h3 class="text-3xl font-bold text-gray-900"><?php echo e($books->total()); ?></h3>
                        ...
                        <div class="flex justify-between items-start">
                            <div>
                                ...
                                <h3 class="text-3xl font-bold text-gray-900">
                                    <?php echo e($books->getCollection()->where('status', 'Available')->count()); ?>
                    ...
                    <div class="bg-[#FEF3C7] p-6 rounded-2xl relative overflow-hidden">
                        <div class="flex justify-between items-start">
                            <div>
                                ...
                                <h3 class="text-3xl font-bold text-gray-900">
                                    <?php echo e($books->getCollection()->where('status', 'Borrowed')->count()); ?>
                    ...
                    <div class="bg-white border border-gray-200 p-6 rounded-2xl relative overflow-hidden">
                        <div class="flex justify-between items-start">
                            <div>
                                ...
                                <h3 class="text-3xl font-bold text-gray-900">
                                    <?php echo e($books->getCollection()->whereIn('status', ['Lost', 'Damaged'])->count()); ?>
                ...
                <div class="bg-white p-4 rounded-2xl shadow-sm border border-gray-100 mb-6">
                    <form method="GET" action="<?php echo e(route('books.index')); ?>" id="searchFilterForm" class="space-y-4">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-6 gap-3">
                            ...
                            <div>
                                ...
                                <div class="relative">
                                    <select name="status" id="statusFilter" class="w-full bg-gray-50 border-none text-sm font-medium rounded-lg py-2.5 px-4 pr-10 focus:ring-2 focus:ring-indigo-500 text-gray-600 cursor-pointer appearance-none">
                                        ...
                                        <?php $__currentLoopData = ['Available','Borrowed','Lost','Damaged']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $s): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            ...
                            <div>
                                ...
                                <input type="number" name="year_from" id="yearFrom" value="<?php echo e($filters['year_from'] ?? ''); ?>" placeholder="2000" min="1900" max="2099"
                                    class="w-full bg-gray-50 border-none text-sm font-medium rounded-lg py-2.5 px-4 focus:ring-2 focus:ring-indigo-500 placeholder-gray-500">
                            </div>

                            <div>
                                <label class="text-xs text-gray-500 mb-1 block">Year To</label>
                                <input type="number" name="year_to" id="yearTo" value="<?php echo e($filters['year_to'] ?? ''); ?>" placeholder="2025" min="1900" max="2099"
                                    class="w-full bg-gray-50 border-none text-sm font-medium rounded-lg py-2.5 px-4 focus:ring-2 focus:ring-indigo-500 placeholder-gray-500">
                            </div>
                        </div>
                        ...
                        <div class="flex items-center justify-between">
                            ...
                            <div class="flex gap-2">
                                <a href="<?php echo e(route('books.index')); ?>" class="px-4 py-2 bg-gray-100 text-gray-600 rounded-lg text-sm font-medium hover:bg-gray-200">
                                ...
                                <a href="<?php echo e(route('books.create')); ?>" class="px-6 py-2 bg-green-600 hover:bg-green-700 text-white rounded-lg text-sm font-bold shadow-sm transition-all">
                ...
                <div class="bg-white rounded-2xl shadow-sm border border-gray-100 overflow-hidden" id="booksTableContainer">
                    ...
                    <?php echo $__env->make('layouts.book-table', ['books' => $books], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
                </div>
            </div>
        </main>
    </div>
    ...
    <script>
        ...
        function performAjaxSearch() {
            ...
            const url = `<?php echo e(route('books.index')); ?>?${params.toString()}`;
...
</html><?php /**PATH C:\Users\Cheng\Documents\GitHub\tarumt-librarySystem\resources\views/books/index.blade.php ENDPATH**/ ?>