                            ...
                            <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-6 hover:shadow-md transition-shadow">
                                <div class="flex items-start justify-between">
                                    <div class="flex items-start gap-4 flex-1">
                                        ...
                                        <div class="flex-shrink-0">
                                            ...
                                            <?php else: ?>
                                                <div class="w-16 h-24 bg-gradient-to-br from-indigo-400 to-indigo-600 rounded-lg shadow flex items-center justify-center">
                                                    <span class="text-white font-bold text-lg"><?php echo e(substr($book->title, 0, 1)); ?></span>
                                                </div>
                                            <?php endif; ?>
                                        </div>
                                        ...
                                        <div class="flex-1">
                                            <div class="flex items-start justify-between mb-2">
                                                <div>
                                                    <h3 class="text-lg font-semibold text-gray-900 mb-1"><?php echo e($book->title); ?></h3>
                                                    <p class="text-sm text-gray-600 mb-2">
                                                        <i class="fa-solid fa-user-pen mr-1"></i><?php echo e($book->author); ?>

                                                        <span class="mx-2">•</span>
                                                        <i class="fa-solid fa-barcode mr-1"></i><?php echo e($book->isbn); ?>
                                            ...
                                            <div class="flex items-center gap-4">
                                                ...
                                                <div class="flex items-center gap-2 text-sm">
                                                    <div class="flex items-center gap-1 px-3 py-1 bg-indigo-50 text-indigo-700 rounded-full border border-indigo-200">
                                                        ...
                                                        <span class="font-semibold"><?php echo e($book->reservations_count); ?></span>
                                                        <span><?php echo e($book->reservations_count === 1 ? 'reservation' : 'reservations'); ?></span>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div class="flex-shrink-0 ml-4">
                                        <a href="<?php echo e(route('reservations.queue', $book->bookId)); ?>" 
...
<?php /**PATH C:\Users\Cheng\Documents\GitHub\tarumt-librarySystem\resources\views/reservations/all-queues.blade.php ENDPATH**/ ?>