...
<body class="bg-[#F3F4F6] text-gray-800">
    ...
    <div class="flex min-h-screen">
        ...
        <main class="flex-1 md:ml-64 relative">
            ...
            <header class="h-20 bg-white border-b border-gray-200 flex items-center justify-between px-8 sticky top-0 z-10">
                ...
                <?php elseif(app(\App\Services\AccessControlService::class)->canEditUser($user)): ?>
    ...
    <div class="p-8">
        ...
        <?php if((Auth::id() === $user->id || ($user->isStudent() && (Auth::user()->isStaff() || Auth::user()->isAdmin()))) && isset($borrowingHistory) && count($borrowingHistory) > 0): ?>
                                ...
                                <td class="px-6 py-4 whitespace-nowrap">
                                    <div class="flex items-center">
                                        ...
                                        <div>
                                            ...
                                            <div class="text-sm text-gray-500"><?php echo e($borrowing['book_author']); ?></div>
                                        </div>
                                    </div>
                                </td>
        ...
        <?php elseif((Auth::id() === $user->id || ($user->isStudent() && (Auth::user()->isStaff() || Auth::user()->isAdmin()))) && (!isset($borrowingHistory) || count($borrowingHistory) === 0)): ?>
        ...
        <?php if((Auth::id() === $user->id || $user->isStudent()) && isset($reservations) && count($reservations) > 0): ?>
        <div class="mt-6 bg-white shadow overflow-hidden sm:rounded-lg">
                                ...
                                <td class="px-6 py-4 whitespace-nowrap">
                                    <div class="flex items-center">
                                        ...
                                        <div>
                                            ...
                                            <div class="text-sm text-gray-500"><?php echo e($reservation['book_author']); ?></div>
                                        </div>
                                    </div>
                                </td>
                                <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-900">
        ...
        <?php elseif((Auth::id() === $user->id || $user->isStudent()) && (!isset($reservations) || count($reservations) === 0)): ?>
        <div class="mt-6 bg-gray-50 border border-gray-200 rounded-lg p-6 text-center">
...
<?php /**PATH C:\Users\User\Documents\GitHub\tarumt-librarySystem\resources\views/users/show.blade.php ENDPATH**/ ?>