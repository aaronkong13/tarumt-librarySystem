        ...
        <tr class="hover:bg-gray-50 transition-colors group">
            <td class="py-4 px-6">
                <div class="flex items-center gap-4">
                    <div class="w-10 h-10 rounded-lg flex-shrink-0 flex items-center justify-center text-sm font-bold text-indigo-600 bg-indigo-50 overflow-hidden">
                        <?php if($book->cover_image): ?>
                            <img src="data:image/jpeg;base64,<?php echo e(base64_encode($book->cover_image)); ?>"
                                 ...
                                 onclick="openImageModal(this.src, '<?php echo e(addslashes($book->title)); ?>')"
                                 title="Click to zoom">
                        <?php else: ?>
                    ...
                    <div>
                        <p class="font-bold text-gray-900 text-sm"><?php echo e($book->title); ?></p>
                        <p class="text-xs text-gray-500 mt-0.5"><?php echo e($book->year); ?></p>
                    </div>
                </div>
            </td>
            ...
            <td class="py-4 px-6">
                <button onclick="openBorrowingHistoryModal(<?php echo e($book->bookId); ?>, '<?php echo e(addslashes($book->title)); ?>')" 
                        ...
                        id="circ-btn-<?php echo e($book->bookId); ?>">
                    <i class="fa-solid fa-rotate-right"></i>
                    <span id="circ-count-<?php echo e($book->bookId); ?>">
            ...
            <td class="py-4 px-6 text-right">
                <div class="flex items-center justify-end gap-2 opacity-0 group-hover:opacity-100 transition-opacity">
                    <button onclick="openAssignModal(<?php echo e($book->bookId); ?>, '<?php echo e(addslashes($book->title)); ?>', '<?php echo e($book->author); ?>', '<?php echo e($book->isbn); ?>', '<?php echo e($book->category); ?>', '<?php echo e($book->status); ?>')" class="w-8 h-8 flex items-center justify-center rounded-lg text-gray-400 hover:text-blue-600 hover:bg-blue-50 transition-colors" title="Assign Book">
                        <i class="fa-solid fa-user-plus text-xs"></i>
                    </button>
                    <a href="<?php echo e(route('books.edit', $book)); ?>" class="w-8 h-8 flex items-center justify-center rounded-lg text-gray-400 hover:text-indigo-600 hover:bg-indigo-50 transition-colors">
                        <i class="fa-solid fa-pen text-xs"></i>
                    </a>
                    <form action="<?php echo e(route('books.destroy', $book->bookId)); ?>" method="POST" onsubmit="return confirm('Delete this book?')">
                        <?php echo csrf_field(); ?>
...
function openBorrowingHistoryModal(bookId, bookTitle) {
    ...
    const apiUrl = '<?php echo e(config("app.api_url") ?? config("app.url")); ?>';
...
<?php /**PATH C:\Users\Cheng\Documents\GitHub\tarumt-librarySystem\resources\views/layouts/book-table.blade.php ENDPATH**/ ?>