                ...
                <form method="POST" action="<?php echo e(route('register')); ?>" class="space-y-6" enctype="multipart/form-data">
                    ...
                    <div>
                        ...
                        <textarea id="address" 
                                  name="address" 
                                  rows="3"
                                  class="mt-1 block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-blue-500 focus:border-blue-500 sm:text-sm"><?php echo e(old('address')); ?></textarea>
                    </div>
...
</html><?php /**PATH C:\xampp\ass\htdocs\tarumt-librarySystem\resources\views/auth/register.blade.php ENDPATH**/ ?>